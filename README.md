...
- **Валідація**: теги, заборонені символи (CJK, російські літери для `uk`), неперекладені латинські слова, ліміт довжини рядка.
...
| `audit [--requeue]` | перевалідувати збережені переклади, знайти заборонені варіанти з глосарію |
...
| `proofread prepare / run / advance / next / submit / status / export` | трирівнева редактура |
